...
namespace ngxsis.Web.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult cekUser(string vData) // nama vUser harus sama dengan yang ada di data ajax
        {
            return Json(AddrBookRepo.GetUname(vData), JsonRequestBehavior.AllowGet);
